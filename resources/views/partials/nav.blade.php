...
<header class='shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px]'>
    <div class='flex flex-wrap items-center justify-between gap-5 relative'>
      ...
      <div class='flex lg:order-1 max-sm:ml-auto'>
        <a href="/login">
            <button class='px-4 py-2 text-sm rounded-full font-bold text-black border-2 border-red bg-blue-200 transition-all ease-in-out duration-300 hover:bg-transparent hover:text-red'>Login</button>
        </a>
